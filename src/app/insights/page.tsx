...
<main style={{ padding: '120px 20px', minHeight: '80vh', background: '#0B1D35', color: '#fff' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "BreadcrumbList",
        "itemListElement": [{"@type":"ListItem","position":1,"name":"Insights","item":"https://www.proconixpmc.com/insights"}]
      }) }} />

  <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
    <h1 style={{ fontSize: '2.5rem', color: '#C9A84C', marginBottom: '20px' }}>Project Governance Insights</h1>
