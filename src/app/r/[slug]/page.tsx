  ...
  return (
    <div style={{ minHeight: '100vh', background: '#07142A', fontFamily: "'DM Sans', 'Helvetica Neue', Arial, sans-serif", color: '#FFFFFF' }}>
      ...
      <nav style={{ background: '#0B1D35', borderBottom: '1px solid rgba(201,168,76,0.2)', padding: '16px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'sticky', top: 0, zIndex: 50 }}>
        <div>
          <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '22px', fontWeight: 700, letterSpacing: '2px', color: '#FFFFFF', textTransform: 'uppercase' }}>PROCONIX</div>
          <div style={{ fontSize: '9px', letterSpacing: '2px', color: '#C9A84C', textTransform: 'uppercase', fontWeight: 600 }}>Project Management Consultancy</div>
        </div>
      ...
      <footer style={{ background: '#07142A', borderTop: '1px solid rgba(201,168,76,0.1)', padding: '32px 24px', textAlign: 'center' }}>
        <div style={{ fontFamily: "'Cormorant Garamond', serif", color: '#FFFFFF', fontSize: '18px', letterSpacing: '2px', textTransform: 'uppercase', marginBottom: '6px' }}>PROCONIX</div>
        <div style={{ color: '#8EA8C3', fontSize: '11px', letterSpacing: '1px', marginBottom: '16px' }}>Project Management Consultancy · Africa · GCC</div>
