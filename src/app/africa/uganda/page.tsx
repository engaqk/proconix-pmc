...
<main style={{ padding: '120px 20px', minHeight: '80vh', background: '#0B1D35', color: '#fff' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "BreadcrumbList",
        "itemListElement": [{"@type":"ListItem","position":1,"name":"Africa","item":"https://www.proconixpmc.com/africa"},{"@type":"ListItem","position":2,"name":"Uganda","item":"https://www.proconixpmc.com/africa/uganda"}]
      }) }} />
