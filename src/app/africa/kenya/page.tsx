...
<main style={{ padding: '120px 20px', minHeight: '80vh', background: '#0B1D35', color: '#fff' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "BreadcrumbList",
        "itemListElement": [{"@type":"ListItem","position":1,"name":"Africa","item":"https://www.proconixpmc.com/africa"},{"@type":"ListItem","position":2,"name":"Kenya","item":"https://www.proconixpmc.com/africa/kenya"}]
      }) }} />

  <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
    <h1 style={{ fontSize: '2.5rem', color: '#C9A84C', marginBottom: '20px' }}>Construction Project Management Consultant Kenya</h1>
