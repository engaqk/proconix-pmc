...
<main>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "BreadcrumbList",
        "itemListElement": [{"@type":"ListItem","position":1,"name":"Executive Governance Briefing Call","item":"https://www.proconixpmc.com/executive-governance-briefing-call"}]
      }) }} />

<section className="cta-section">
  <div className="container">
    <div className="section-eyebrow" style={{"justifyContent":"center"}}>Start the Conversation</div>
    <h1>Your Project Has a Window.<br/><em>Governance Has a Starting Point.</em></h1>
    <div>
