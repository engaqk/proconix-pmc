...
<main>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "BreadcrumbList",
        "itemListElement": [{"@type":"ListItem","position":1,"name":"Case Evidence","item":"https://www.proconixpmc.com/case-evidence"},{"@type":"ListItem","position":2,"name":"Case 3","item":"https://www.proconixpmc.com/case-evidence/case-3"}]
      }) }} />

<section className="cases-section" id="cases">
  <div className="container">
    <div className="section-eyebrow">Anonymised Case Evidence</div>
    <h1 className="section-title">Governance That Changed<br/><em>the Project Outcome</em></h1>
