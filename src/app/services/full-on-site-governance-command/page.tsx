...
<main>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "BreadcrumbList",
        "itemListElement": [{"@type":"ListItem","position":1,"name":"Services","item":"https://www.proconixpmc.com/services"},{"@type":"ListItem","position":2,"name":"Full On Site Governance Command","item":"https://www.proconixpmc.com/services/full-on-site-governance-command"}]
      }) }} />
